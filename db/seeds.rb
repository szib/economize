...
price_record_1 = PriceRecord.create(effective_from: DateTime.new(2017, 3, 1), monthly_price: 20.10, service_id: 1)
price_record_2 = PriceRecord.create(effective_from: DateTime.new(2018, 12, 10), monthly_price: 10.20, service_id: 2)
price_record_3 = PriceRecord.create(effective_from: DateTime.new(2016, 10, 10), monthly_price: 15.50, service_id: 3)
price_record_4 = PriceRecord.create(effective_from: DateTime.new(2018, 9, 5), monthly_price: 7.99, service_id: 2)
price_record_5 = PriceRecord.create(effective_from: DateTime.new(2019, 2, 2), monthly_price: 15.99, service_id: 3)
